...
; 0000 008E         if(adelante==0)         //adelate
	SBIC 0x16,0
	RJMP _0x6
; 0000 008F             intervalo=50;
	LDI  R30,LOW(50)
	RJMP _0x13
; 0000 0090         else if(atras==0)       //atras
_0x6:
	SBIC 0x16,1
	RJMP _0x8
; 0000 0091             intervalo=100;
	LDI  R30,LOW(100)
	RJMP _0x13
; 0000 0092         else if(izquierda==0)       //izquierda
_0x8:
	SBIC 0x16,2
	RJMP _0xA
; 0000 0093             intervalo=150;
	LDI  R30,LOW(150)
	RJMP _0x13
; 0000 0094         else if(derecha==0)       //derecha
_0xA:
	SBIC 0x16,3
	RJMP _0xC
; 0000 0095             intervalo=200;
	LDI  R30,LOW(200)
	RJMP _0x13
; 0000 0096         else
_0xC:
; 0000 0097             intervalo=250;
	LDI  R30,LOW(250)
_0x13:
	MOV  R5,R30
; 0000 0098 
