...
;DATA STACK POINTER INITIALIZATION
	...
	.CSEG
;/*******************************************************
;This program was created by the CodeWizardAVR V3.39a
...
; 0000 007D // The Analog Comparator's negat ive input is
...
_0x27:
	BLD  R2,0
; 0000 0096             if (up_a==0){ //hubo cambio de flanco de 1 a
	SBRC R2,0
	RJMP _0x8
; 0000 0097                 PORTA.0 = 1;
	SBI  0x1B,0
...
; 0000 0099                 PORTA.0 = 0;
	RCALL SUBOPT_0x1
; 0000 009A               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
; 0000 009B             }
; 0000 009C             if (up_a==1) //hubo cambio de flanco de 0 a 1
_0x8:
	SBRC R2,0
; 0000 009D               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
	RCALL SUBOPT_0x2
; 0000 009E 
; 0000 009F         //Boton down
; 0000 00A0             if (down==0)
	SBIC 0x16,1
	RJMP _0xE
; 0000 00A1               down_a=0;
...
_0x28:
	BLD  R2,1
; 0000 00A4             if (down_a==0){ //hubo cambio de flanco de 1 a
	SBRC R2,1
	RJMP _0x10
; 0000 00A5                 PORTA.0 = 1;
	SBI  0x1B,0
...
; 0000 00A7                 PORTA.0 = 0;
	RCALL SUBOPT_0x1
; 0000 00A8               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
; 0000 00A9             }
; 0000 00AA             if (down_a==1) //hubo cambio de flanco de 0 a 1
_0x10:
	SBRC R2,1
; 0000 00AB               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
	RCALL SUBOPT_0x2
; 0000 00AC 
; 0000 00AD         //Boton left
; 0000 00AE             if (left==0)
	SBIC 0x16,2
	RJMP _0x16
; 0000 00AF               left_a=0;
...
_0x29:
	BLD  R2,2
; 0000 00B2             if (left_a==0){ //hubo cambio de flanco de 1 a
	SBRC R2,2
	RJMP _0x18
; 0000 00B3                 PORTA.0 = 1;
	SBI  0x1B,0
; 0000 00B4                 delay_ms(11);
	LDI  R26,LOW(11)
	RCALL SUBOPT_0x0
; 0000 00B5                 PORTA.0 = 0;
	RCALL SUBOPT_0x1
; 0000 00B6               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
; 0000 00B7             }
; 0000 00B8             if (left_a==1) //hubo cambio de flanco de 0 a 1
_0x18:
	SBRC R2,2
; 0000 00B9               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
	RCALL SUBOPT_0x2
; 0000 00BA 
; 0000 00BB         //Boton right
; 0000 00BC             if (right==0)
	SBIC 0x16,3
	RJMP _0x1E
; 0000 00BD               right_a=0;
	CLT
...
_0x2A:
	BLD  R2,3
; 0000 00C0             if (right_a==0){ //hubo cambio de flanco de 1 a
	SBRC R2,3
	RJMP _0x20
; 0000 00C1                 PORTA.0 = 1;
	SBI  0x1B,0
...
; 0000 00C3                 PORTA.0 = 0;
	RCALL SUBOPT_0x1
; 0000 00C4               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
; 0000 00C5             }
; 0000 00C6             if (right_a==1) //hubo cambio de flanco de 0 a 1
_0x20:
	SBRC R2,3
; 0000 00C7               delay_ms(20); //Se coloca retardo de 40mS para eliminar rebotes
	RCALL SUBOPT_0x2
; 0000 00C8 
; 0000 00C9        }
	RJMP _0x3
