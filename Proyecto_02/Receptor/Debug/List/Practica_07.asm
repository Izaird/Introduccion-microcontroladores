...
; 0000 008F while (1){
_0x3:
; 0000 0090     count = 2000;
	LDI  R30,LOW(2000)
	LDI  R31,HIGH(2000)
	MOVW R12,R30
; 0000 0091     while(count){
_0x6:
	MOV  R0,R12
	OR   R0,R13
	BREQ _0x8
; 0000 0092         if (boton==1)
	SBIS 0x10,0
	RJMP _0x9
; 0000 0093             botona=1;
	SET
...
_0x4A:
	BLD  R2,1
; 0000 0096         if ((botonp==0)&&(botona==1)){ //hubo cambio de flanco de 1 a 0
	SBRC R2,0
	RJMP _0xC
	SBRC R2,1
	RJMP _0xD
_0xC:
	RJMP _0xB
_0xD:
; 0000 0097             var1+=9; //Se incrementa la variable
	MOVW R30,R4
	ADIW R30,9
	MOVW R4,R30
; 0000 0098             delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	...
	RCALL _delay_ms
; 0000 0099         }
; 0000 009A         if ((botonp==1 )&&(botona== 0)) //hubo cambio de flanco de 0 a 1
_0xB:
	SBRS R2,0
	RJMP _0xF
	SBRS R2,1
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 009B             delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
...
; 0000 00A4         PORTB.3 = 0;
	RJMP _0x4B
; 0000 00A5     }
; 0000 00A6     else if(var1>=60 && var1<=80){
_0x11:
	LDI  R30,LOW(60)
	LDI  R31,HIGH(60)
	RCALL SUBOPT_0x0
...
; 0000 00AA         PORTB.3 = 1;
	SBI  0x18,3
; 0000 00AB     }
; 0000 00AC     else if(var1>=30 && var1<=50){
	RJMP _0x28
_0x1D:
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
...
; 0000 00B1     }
; 0000 00B2 
; 0000 00B3     else if(var1>=1 && var1<=20){
_0x29:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	RCALL SUBOPT_0x0
